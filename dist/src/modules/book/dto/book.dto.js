...
exports.QueryBookDto = exports.CrawlBook = exports.UpdateBookRequestDto = exports.CreateBookRequestDto = exports.UpdateChapterRequestDto = exports.CreateChapterRequestDto = void 0;
...
__decorate([
    ...
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
], CreateBookRequestDto.prototype, "authorDescription", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
], CreateBookRequestDto.prototype, "image", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
...
__decorate([
    ...
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
], UpdateBookRequestDto.prototype, "authorDescription", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
], UpdateBookRequestDto.prototype, "image", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        enum: enums_1.EReleaseStatus,
        default: enums_1.EReleaseStatus.RELEASING,
...
], CrawlBook.prototype, "data", void 0);
CrawlBook = __decorate([
    (0, class_transformer_1.Exclude)()
], CrawlBook);
...
__decorate([
    ...
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
], QueryBookDto.prototype, "bookName", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
], QueryBookDto.prototype, "authorName", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    ...
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", Number)
], QueryBookDto.prototype, "categoryName", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    ...
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", Boolean)
], QueryBookDto.prototype, "isVip", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        type: enums_1.EReleaseStatus,
        enum: Object.values(enums_1.EReleaseStatus),
    }),
    (0, class_validator_1.IsEnum)(enums_1.EReleaseStatus),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", Number)
], QueryBookDto.prototype, "releaseStatus", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        type: enums_1.ESortBy,
        enum: Object.values(enums_1.ESortBy),
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(enums_1.ESortBy),
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", Number)
], QueryBookDto.prototype, "sortBy", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        type: enums_1.ESortType,
        enum: Object.values(enums_1.ESortType),
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(enums_1.ESortType),
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
], QueryBookDto.prototype, "sortType", void 0);
QueryBookDto = __decorate([
    (0, class_transformer_1.Exclude)()
], QueryBookDto);
